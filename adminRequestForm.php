...
<body>
    ...
    <div class="requestForm-frame1">
        ...
        <div class="requestForm-frame2"><br><br>
          ...
          <h1 class="dashboardAnnouncement">Form List</h1>
        </div><br>

        <table class="requestform-table">
            <tr>
              <th class="rf">No.</th>
              <th class="rf">Form Name</th>
              <th class="rf">Price</th>
            ...
            <tr class="reqf">
              ...
              <td class="req">200</td>
              <td class="req"><a href="#"><button class="reqform-btn" onclick="document.getElementById('sf01').style.display='block'">Send Request</button></a></td>
            </tr>
            <tr>
              <td class="req">2</td>
              <td class="req">TOR</td>

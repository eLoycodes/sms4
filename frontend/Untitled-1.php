...
<body>
    ...
    <table class="edit-table0">
        ...
        <tr class="trans-tr">
            ...
            <td><button type="submit" class="reqform-btn" name="submit">Remove</button></td>
        </tr>
    </table>
</div>

<div id="edit-form1" style="display: none;"> <!-- Initially hidden -->
    <div class="callout callout-info">
    <div class="edit-form1">
    <div class="trans-td">
        <h3 class="edit-heading" style="font-size: 16px; margin-top: 5%;">Select Subject</h3>
    </div>
    <form id="subjectForm">
